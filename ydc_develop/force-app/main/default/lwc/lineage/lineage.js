...
import getLineageData from '@salesforce/apex/Lineage.getLineageData';
export default class Lineage extends LightningElement {
@api recordId;
@api objectApiName;
@track errors;
@api LineageData;
...
@wire(getLineageData,{recordId:'$recordId'}) lineageData
({ error, data }) {
if (data) {
    console.log(data);
...
callback() {
  ...
  //parsing the String 
  treeData = JSON.parse(this.LineageData);
