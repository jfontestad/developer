...
import DatasetFilter from 'c/datasetFilter';
...
describe('c-dataset-filter', () => {
    ...
    describe('filterChange event', () => {
        ...
        it('fired when search value changes', () => {
            ...
            const element = createElement('c-dataset-filter', {
                is: DatasetFilter
            });
            document.body.appendChild(element);
        ...
        it('fired when checkbox is toggled', () => {
            ...
            return Promise.resolve()
                .then(() => {
                    verifyFilterToggle(element, 'regions');
                })
                // .then(() => {
    ...
    describe('getPicklistValues @wire error', () => {
        ...
        it.each(['regions'])(//, 'materials', 'levels'])(
